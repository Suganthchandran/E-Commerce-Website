    ...
    <div className='product-details'>
      ...
      <div className='product-detail-main'>
        ...
        <div>
          ...
          <p className='product-details-price'>{currency}{productData.price}</p>
      ...
      {/* Related Products */}
              <RelatedProducts id={productData._id} category={productData.category} type={productData.type} clothing={productData.clothing} material={productData.material} />
