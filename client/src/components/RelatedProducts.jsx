...
const RelatedProducts = ({id,category,type,clothing,material}) => {
    ...
    useEffect(()=>{
        if(products.length > 0) {
            ...
            productsCopy = productsCopy.filter((item) => item.type === type);
            productsCopy = productsCopy.filter((item) => item.clothing === clothing);
