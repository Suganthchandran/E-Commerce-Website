...
const Add = ({token}) => {
    ...
    const [type,setType] = useState("Animewear");
  ...
  return (
    <form onSubmit={handleSubmit} className='add-form'>
        ...
        <div className='add-form-content'>
            ...
            <div>
                <p className='add-form-select-head'>Product Type</p>
                <select onChange={(e)=>setType(e.target.value)} className='add-form-select'>
                    <option value="Animewear">Animewear</option>
            ...
            <div>
                <p className='add-form-select-head'>Product Clothing</p>
                <select onChange={(e)=>setClothing(e.target.value)} className='add-form-select'>
                    <option value="Shirt">Shirt</option>
                    <option value="T-Shirt">T-Shirt</option>
                    <option value="Oversized T-Shirts">Oversized T-Shirts</option>
                    <option value="Hoodie">Hoodie</option>
                    <option value="Jeans">Jeans</option>
                    <option value="Jeans">Top</option>
                    <option value="Jeans">Leggins</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select onChange={(e)=>setMaterial(e.target.value)} className='add-form-select'>
                    ...
                    <option value="Ligra">Ligra</option>
